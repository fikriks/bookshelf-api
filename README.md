...
Submission atau Tugas Akhir Kelas [Belajar Membuat Aplikasi Back-End untuk Pemula dengan Google Cloud](https://www.dicoding.com/academies/342/) By Dicoding Indonesia
## Menjalankan Server
...
$ npm run start
```
Untuk testing, buka web browser, lalu ketikkan alamat url:
